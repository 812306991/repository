...
public class StringUtils
{
	...
	/**
	 * 判断字符串是否以某些特定的字符串结尾,忽略大小写
	 * @param k
	 * @param p
	 * @return
	 */
	public static boolean isEndedInArrays(String k,String...p){
		StringBuilder sb=new StringBuilder("(?i)(\\s|\\S)+("); 
		...
		sb.append(")$");
		Matcher matcher = Pattern.compile(sb.toString()).matcher(k); 
		return matcher.find();
	}
	/**
     * 判断一个字符串是否包含指定的字符串
	...
	/**
	 * @Description: 判断字符串是否数值(包括正数、负数、小数)
	 * @param str
	 * @return boolean  
	 * @author MingChang.Wei
	 * @date 2017年2月8日 下午6:40:36
	 */
	...
	/**
	 * @Description: 判断字符串是否数值(科学计数)
	 * @param str
	 * @return boolean  
	 * @author MingChang.Wei
	 * @date 2017年2月8日 下午6:40:36
	 */
	public static boolean isNumKX(String str) {
	...
	/**
     * @Description: 判断字符串是否数值(正数)
     * @param str
     * @return boolean  
     * @author MingChang.Wei
     * @date 2016年11月8日 下午3:07:17
     */
