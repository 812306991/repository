...
<body class="easyui-layout">
	...
	<div data-options="region:'center'" style="background:#eee; width:auto;">
...
<!-- 		    </div>   -->
	...
	<div region="south" style="height: 25px;padding: 5px" align="center">
		Copyright © 2017-2018廖光追的SSM博客系统 版权所有
	</div>
<!-- 	<a href="http://localhost:8080/blog/user/getAllUser">进入用户管理页</a> -->
</body>
</html>